  ...
  useEffect(() => {
    if (showConfetti) {
      const timer = setTimeout(() => {
        setShowConfetti(false); // Hide the confetti after 3 seconds
      }, 10000);
      ...
      >
        ...
        >
          ...
          <Flex alignItems="center" mb={2} mt={-10} gap={7}>
            <Text fontSize="xl" fontWeight="bold" color="white" gap={2}>
              {user?.spins > 0
                ? `Free Spin Left: ${user.spins} ${user.spins > 1 ? "s" : ""} `
                : "No Free Spins Left"}
            </Text>
            <Tooltip
        ...
        <Flex alignItems="center" mb={2}>*/}
            <Text fontSize="xl" fontWeight="bold" color="white">
              {bonusSpins > 0
                ? `Bonus Spin Left: ${bonusSpins} ${bonusSpins > 1 ? "s" : ""} `
                : "No Bonus Spins"}
            </Text>
            <Tooltip
